...
if($_POST['title']){
    ...
    $new_adresse = $stats_mysql->real_escape_string($_POST['adresse']);
    $new_contact = $stats_mysql->real_escape_string($_POST['contact']);
    $new_email = $stats_mysql->real_escape_string($_POST['email']);
    $new_name = $stats_mysql->real_escape_string($_POST['name']);

    $stats_mysql->query("UPDATE contact SET title = '".$new_title."', adresse = '".$new_adresse."', email ='".$new_email."', contact ='".$new_contact. "', name ='".$new_name."' WHERE title = '".$stats[4]."' LIMIT 1 ;");
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                    ...
                    <form class="form-horizontal" action="contact.php" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input value="<?php echo $stats[4]; ?>" id="title" name="title" type="text" class="form-control">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input value="<?php echo $stats[0]; ?>" id="name" name="name" type="text" class="form-control">
                                </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="adresse" name="adresse" type="adresse" class="form-control"><?php echo $stats[1]; ?></textarea>
                                </div>
                                ...
                                <div class="col-md-10">
                                    <input value="<?php echo $stats[2]; ?>" id="email" name="email" type="text" class="form-control">
                                </div>
                            </div>           
                                           
                                            <div class="form-group">
                                <label class="col-md-2 control-label" for="kontakt">Kontakt</label>
                                <div class="col-md-10">
                                    <input value="<?php echo $stats[3]; ?>" id="contact" name="contact" type="text" class="form-control">
                                </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">created by Timo J. & Sascha W.</p>
        </div>
    </div><!--/.row-->
</div>	<!--/.main-->
